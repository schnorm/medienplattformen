...
% AKTIVIERUNGSBLOCK „Gender-Disclaimer" (OPTIONAL, IU-Richtlinien Anhang A) —
% separate Seite vor dem Hauptteil bei Nutzung des generischen Maskulinums.
% Im Auslieferungszustand AKTIV: An der IU besteht keine generelle Genderpflicht,
% und der Disclaimer macht aus der Sprachwahl eine sichtbare Entscheidung.
% Auskommentieren, wenn der Studiengang gendersensible Sprache verlangt.
% \include{pages/gender}
