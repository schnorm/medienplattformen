...
Die Aufgabenstellung nennt Hobbyköch:innen als Zielgruppe. Die Einleitung hat bereits begründet, warum sich dieser Projektbericht auf die nachhaltigkeitsorientierte Teilgruppe verengt (siehe~\autoref{sec:zielsetzung_und_verengung}). Dieser Abschnitt beschreibt, wer zu dieser Teilgruppe gehört, und leitet daraus die Anforderungen an Resteria ab.
