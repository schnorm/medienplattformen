...
- **Trichter statt Vorwegnahme**: Nennt die Einleitung Vergleichsobjekte (Konkurrenzprodukte, Fallbeispiele), die ein späteres Kapitel vertieft analysiert, bleibt die Einleitung auf der Behauptungsebene (Kategorien, Beispiele, die Lücke selbst) — Kriterienmatrix, Testberichte und sonstige Detailbelege sind dem Analysekapitel vorbehalten. Dieselben Beispiele in beiden Kapiteln sind erwünscht (Roter Faden), solange nur das spätere Kapitel die Evidenz liefert.
