...
- **Mechanische Formalia deterministisch prüfen statt lesen**: `python .claude/skills/_shared/scripts/check_formalia.py chapters/` (Pronomen, quote-Env, gerade Anführungszeichen, `\include`, `[H]`, Caption-Reihenfolge, `\underline`, `~\autoref`, Gedankenstrich-Häufung, Blockzitat > 40 Wörter, ½-Seiten-Heuristik, Überschriften-Dopplung, Satzlängen-Heuristik > 30 Wörter, Meta-Verben-/Nominalstil-Marker, Dreier-Aufzählungs-Häufung, Absatz-Gleichförmigkeit, Fragesätze im Fließtext, Wortdopplungen).
