...
- **Pflicht**: Leitfrage ≠ These · Forschungslücke in Einleitung (Literaturlücke) · Aktualität/Zeitbezug in Einleitung · Normative Ebene der These · Turning Point im Theorie-Kapitel · Gegenargument pro zentralem Argument reflektiert & entkräftet · Syntheseleistung pro Hauptkapitel · Limitationen dreischichtig (warum · Mitigation · zukünftige Forschung)
- **Empfohlen**: Erklärende Ebene der These
- **Optional**: Literatur-Landkarte
- **Entfällt**: Ergebnisse ≠ Interpretation · Methodik-Sektion + Methoden-Reflexion · Anwendungsmatrix (Theorie × Fall) · Phasenplanung als Tabelle
...
|---|---|---|
| Einleitung | 10 % | Problem, Forschungslücke, Aktualität, Leitfrage, Aufbau |
| Theorie (2–3 Konzepte) | Hauptteil (größter Anteil) | Konzepte + roter Faden + Turning Point |
| Diskussion | Hauptteil | Pro/Contra, Synthese, Gegenargument entkräftet |
| Schluss | 10 % | Leitfragenbeantwortung, Synthese, Limitationen dreischichtig, Ausblick |

Gesamt: 7–10 S. (B.Sc.) / 12–15 S. (M.Sc.). Einl. 10 % / Haupt 80 % / Schluss 10 %.
...
**Claim-Regeln**: Strenger Standard, viele FACTUAL CLAIMS (mit `\parencite{}`). Eigene Schlussfolgerung = ARGUMENTATION (keine Citation).

**Absätze pro Subsection (Richtwert)**: 3–5

## Audit-Checks & Outline

- [ ] Argumentationsqualität: Hauptaussage + Beleg pro Absatz?
- [ ] Theorie-Verankerung in jedem Kapitel?
...
**Claim-Extraction**: Strenger Standard, viele FACTUAL. Eigene Schlussfolgerung = ARGUMENTATION.
