...
- **Pflicht**: Leitfrage ≠ These · Forschungslücke in Einleitung (fallbezogene Lücke/Frage) · Normative Ebene der These (Empfehlung) · Turning Point im Theorie-Kapitel · Gegenargument pro zentralem Argument reflektiert & entkräftet · Syntheseleistung pro Hauptkapitel · Limitationen dreischichtig (warum · Mitigation · zukünftige Forschung) · **Anwendungsmatrix (Theorie × Fall)**
- **Empfohlen**: Erklärende Ebene der These
- **Optional**: Aktualität/Zeitbezug in Einleitung (Fallbezug wichtiger als Zeitbezug)
...
|---|---|---|
| Einleitung | ~10–15 % | Fallvorstellung, Verortung, Forschungslücke/-frage für den Fall, Vorgehen |
| Theorie (2–3 Konzepte) | Hauptteil | Konzepte + Relevanz für den Fall + Turning Point |
| Fallanalyse | Hauptteil (größter Anteil) | Theorie auf Fall anwenden, Lösungsvarianten, begründete Empfehlung |
| Schluss | ~10–15 % | Erkenntnisse, Übertragbarkeit, Limitationen dreischichtig |
...
**Claim-Regeln**: Fall-spezifische Aussagen = OWN WORK (kein `\cite{}`, ggf. „Quelle: Eigene Darstellung." bei Abb./Tab.). Theorie-Aussagen brauchen `\parencite{}`. Empfohlene Lösung = ARGUMENTATION.

**Absätze pro Subsection (Richtwert)**: 4–6 (Theorie/Fall wechselnd)

## Audit-Checks & Outline

- [ ] Jeder Theorieblock auf den Fall angewendet?
- [ ] Transferleistung sichtbar?
- [ ] Lösungsbegründung aus Theorie?
- [ ] Übertragbarkeit diskutiert?
- [ ] Theorie-Kapitel knapp und anwendungsorientiert (kein Konzept-Reproduzieren)?
- [ ] Quellen: 1 Fall-PDF + 3–8 Theorie? (Richtwert aus der Praxis, keine IU-Vorgabe)

**Outline-Check (Soll-Struktur, identisch mit Plan-Modus Schritt 2.5):**
Einleitung (Fallvorstellung, Verortung, Vorgehen) → Theorie (2–3 Konzepte) → Fallanalyse (Theorie auf Fall, Lösungsvarianten, Empfehlung) → Schluss (Übertragbarkeit, Limitationen)

**Claim-Extraction**: Fall-spezifisch = OWN WORK. Theorie = FACTUAL. Empfehlung = ARGUMENTATION.
