...
6. **Im Abgabe-Audit blockierend.** Offene Befunde der Klassen WORTLAUT, ZITAT WEICHT AB, SEITE VERDÄCHTIG, SEITE AUSSERHALB, NICHT GEFUNDEN und CLAIM SCHÄRFER verhindern die Abgabe-Freigabe – das sind genau die Fälle, die in einer Bewertung als Falschzitat oder Übernahme gelten. In früheren Audits sind sie Arbeitsaufträge mit Score-Abzug.
